...
class Lepton {
 ...
 Lepton(LeptonType leptonType00, unsigned int leptonIndex00, TLorentzVector& vLepton00, double& eta00, double& chiNdof00, double& D000, double& D0Error00, double& D0Significance00, double& dxy_BS00, double& dz_BS00, double& charge00, FakeType fakeType00, LooseTight looseTight00, double& absTrkIso00, double& relIso00)
   : leptonType_(leptonType00), leptonIndex_(leptonIndex00), lorentzVec_(vLepton00), eta_(eta00), chiNdof_(chiNdof00), D0_(D000), D0Error_(D0Error00), D0Significance_(D0Significance00), dxy_BS_(dxy_BS00), dz_BS_(dz_BS00), charge_(charge00), fakeType_(fakeType00), looseTight_(looseTight00), absTrkIso_(absTrkIso00), relIso_(relIso00) {};
  ~Lepton() {};
  ...
  double D0Significance() { return D0Significance_; }
